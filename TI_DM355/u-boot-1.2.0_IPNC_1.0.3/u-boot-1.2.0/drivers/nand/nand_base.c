...
#define DMA_TIMEOUT 0xFFFF0000     /* DMA */


/*
 * NAND low-level MTD interface functions
 */
static unsigned char  gDMACopy = 0;   /* flag to use DMA copy for NAND */
...
#if 0 /* See below where DMA added */
 ...
 * Default read function for 8bit buswith
 *
 * NAND read using DMA implemented - ANR
 */
static void nand_read_buf(struct mtd_info *mtd, u_char *buf, int len)
{

      if(gDMACopy == 0){                                     /* check to copy the data using DMA */
        int i; 
        struct nand_chip *this = mtd->priv;
        ...
        volatile unsigned int count = DMA_TIMEOUT;
        volatile unsigned int status = 0;

        *((volatile unsigned int*)(0x01c02070)) |= 0xFFFFFFFF;                 //ICR for Channel 0
	*((volatile unsigned int*)(0x01c04000)) = 0x00100004;                  //OPT = 0x00100004;
        *((volatile unsigned int*)(0x01c04004)) = 0x02000000;                  //SRC = 0x02000000;
        *((volatile unsigned int*)(0x01c04008)) = ((len/8)<<16) | (0x8);       //A_B_CNT = ((numBytes/8)<<16) | (0x8);
        *((volatile unsigned int*)(0x01c0400C)) = (unsigned int)((&buf[0]));   //DST = (Uint32)((&destAddr[0]));
        *((volatile unsigned int*)(0x01c04010)) = 0x00080000;                  //SRC_DST_BIDX = 0x00080000;
        *((volatile unsigned int*)(0x01c04014)) = 0x0;                         //LINK_BCNTRLD = 0x0;
        *((volatile unsigned int*)(0x01c04018)) = 0x0;                         //SRC_DST_CIDX = 0x0;
        *((volatile unsigned int*)(0x01c0401C)) = 0x1;                         //CCNT = 1;
        *((volatile unsigned int*)(0x01c02030)) |= 0x1;                        //EESR |= 0x1;
        *((volatile unsigned int*)(0x01c02010)) |= 0x1;                        //ESR  |= 0x1;
	    
	do { 
		status = ( (*((volatile unsigned int*)(0x01c02068))) & (0x00000001));//IPR
		count --;
