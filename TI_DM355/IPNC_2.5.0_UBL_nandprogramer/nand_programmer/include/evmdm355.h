 ...
 *  Function Renaming                                                       *
 * ------------------------------------------------------------------------ */
#define EVMDM350_wait          _wait
#define EVMDM350_waitusec      _waitusec
...
Int16 EVMDM350_init( );
Int16 EVMDM350_startupGEL( );

Int16 EVMDM350_PMX_init ( );
Int16 EVMDM350_PMX_set  ( Uint32 pinmux0, Uint32 pinmux1 );
Int16 EVMDM350_PMX_clear( Uint32 pinmux0, Uint32 pinmux1 );
 ...
 *  PSC Prototypes                                                          *
 * ------------------------------------------------------------------------ */
Int16 EVMDM350_initPsc( );

Int16 EVMDM350_PSC_enableAll( );
Int16 EVMDM350_PSC_changeState( Uint32 id, Uint16 state );

#define EVMDM350_enableAllPowerModules EVMDM350_PSC_enableAll
#endif
