...
#define FBIO_SETPOS		_IOW('F', 0x22, u_int32_t)

/* Backported IOCTLS. */
#define FBIO_SETPOSX            _IOW('F', 0x50, u_int32_t)
#define FBIO_SETPOSY            _IOW('F', 0x51, u_int32_t)
#define FBIO_SETZOOM            _IOW('F', 0x52, struct zoom_params)
#define FBIO_GETSTD             _IOR('F', 0x53, u_int32_t)
...
#define FBIO_REG_DUMP \
	_IOWR('F', 0x49, struct reg_dump)
#define FBIO_SET_TV_SYSTEM \
	_IOWR('F', 0x50, unsigned int)
 ...
 */
#ifdef __KERNEL__
#define DM355FB_DEVICE "dm355fb"
#define DM355FB_DRIVER "dm355fb"
...
#define BITMAP_2BIT	2
#define BITMAP_4BIT	4
#define BITMAP_8BIT	8
#define YUV422_RGB565	16
#define RGB888		24
...
/*
 * Functions Definitions for 'dm355fb' module
 */
int is_rgb565(struct fb_var_screeninfo);
...
void set_win_position(char *, unsigned int, 
...
/*
 * Function definations for Digital LCD module
 */
...
void vpbe_dfb_480p_prgb_config(void);
#endif				/*__KERNEL__*/

#endif				/* End of #ifndef DM355_VPBE_H */
