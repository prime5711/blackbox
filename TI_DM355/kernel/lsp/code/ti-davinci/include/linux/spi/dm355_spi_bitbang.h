 ...
 * methods, if you like.
 */ 
extern int dm355_spi_bitbang_setup(struct spi_device *spi);
extern void dm355_spi_bitbang_cleanup(const struct spi_device *spi);
extern int dm355_spi_bitbang_transfer(struct spi_device *spi,
                                       struct spi_message *m);
extern int dm355_spi_bitbang_setup_transfer(struct spi_device *spi,
                                             struct spi_transfer *t);

/* start or stop queue processing */ 
extern int dm355_spi_bitbang_start(struct spi_bitbang *spi);
extern int dm355_spi_bitbang_stop(struct spi_bitbang *spi);
