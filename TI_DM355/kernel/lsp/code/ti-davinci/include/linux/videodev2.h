...
#define V4L2_CID_BIN			(V4L2_CID_BASE+24)
#define V4L2_CID_MEDIAN			(V4L2_CID_BASE+25)
#define V4L2_CID_50_60Hz		(V4L2_CID_BASE+26)
#define V4L2_CID_BIN_SKIP_MODE		(V4L2_CID_BASE+27)
#define V4L2_CID_FRM_CTRL		(V4L2_CID_BASE+28)
...
typedef struct ccdc_reg_apro
{
	int ccdc_addr;
	int val;	
}ccdc_reg_apro;
typedef struct mt9m131_reg_apro
{
	int page;
	int mt9m131_addr;
	int val;	
...
#if 1 // added by xact for read and write CCDC register 2009.01.08
#define VIDIOC_READ_CCDC	_IOWR  ('V', 6, int)
#define VIDIOC_WRITE_CCDC	_IOWR  ('V', 7, int)
#define VIDIOC_WRITE_CCDC2	_IOWR  ('V', 69, struct ccdc_reg_apro)
#define VIDIOC_WRITE_MT9M131	_IOWR  ('V', 70, struct mt9m131_reg_apro)
#define VIDIOC_READ_MT9M131	_IOWR  ('V', 71, struct mt9m131_reg_apro)
#define VIDIOC_MT9M131_IOCTL	_IOWR  ('V', 72, struct mt9m131_reg_apro)
#endif
...
#define TVP5150_SHOW_ALL	_IOWR  ('V', 70, int)
#define TVP5150_READ		_IOWR  ('V', 71, int)
#define TVP5150_WRITE		_IOWR  ('V', 72, int)
#define TVP5150_NTSC_PAL	_IOWR  ('V', 73, int)
#define PINMUX3_UART2		_IOWR  ('V', 74, int)
#define MT9M131_SHOW_ALL	_IOWR  ('V', 75, int)
#define MT9P031_SHOW_ALL	_IOWR  ('V', 76, int)
#define MT9M131_WRITE_INIT	_IOWR  ('V', 77, int)
#define TVP5150_RESET_PAL	_IOWR  ('V', 78, int)
#define TVP5150_EPROM	_IOWR  ('V', 79, int)
#define CCDC_SHOW_ALL	_IOWR  ('V', 80, int)
