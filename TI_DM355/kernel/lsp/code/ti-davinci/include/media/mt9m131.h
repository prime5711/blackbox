...
#define	MT9M131_MODE_D1_NTSC_30FPS		(26)
#define	MT9M131_MODE_D1_NTSC_15FPS		(27)
#define	MT9M131_MODE_1440_1024_15FPS	(28)
#define	MT9M131_MODE_800_600			(29)
#define	MT9M131_MODE_QVGA_30FPS			(30)

#define PO1150K_CONNECT_TYPE (1)

/*i2c adress for MT9M131*/

#define NEW_CMOS_CONNECT_HAVETO_NO_MIRROR (1)

#ifdef PO1150K
 #ifndef PO1150K_CONNECT_TYPE
 	#error 111111111111111111111111111
	//yun for 2M Aptina MT9D111
   #define MT9M131_I2C_ADDR  		(0xEC>>1)	// 0x76
   #define MT9M131_I2C_ADDR_1  		(0xE8>>1)	// 0x76
//   #define MT9M131_I2C_ADDR  		(0x90>>1)	// 0x76
//   #define MT9M131_I2C_ADDR_1  		(0x90>>1)	// 0x76
 #else
 	#ifdef NEW_CMOS_CONNECT_HAVETO_NO_MIRROR
	   #define MT9M131_I2C_ADDR  		(0xEC>>1)	// 0x74
	#else
 	#error 3333333333333333333333333333
	   #define MT9M131_I2C_ADDR  		(0xE8>>1)	// 0x74
   #endif
 #endif 
#else
...
#define MT9M131_I2C_ADDR  		(0xBA>>1)	//0x5D
#else
