/*
 * drivers/media/video/mt9m112_davici.h
 *
...
#ifndef _MT9M112_DAVINCI_H
#define _MT9M112_DAVINCI_H
...
/**
 * struct mt9m112_platform_data - Platform data values and access functions.
...
#define MT9M112_I2C_ADDR  		(0xBA >>1)
...
#define MT9M112_VGA_30FPS  (1130)
#define MT9M112_QVGA_30FPS  (1131)

/*Defining an output to recognize mt9m112 hardware, 
instead of tvp514x outputs*/

enum mt9m112_output {
       OUTPUT_8BIT_422_VGA = 5,
       OUTPUT_8BIT_422_SXVGA = 6,
};

#endif				/* ifndef _MT9M112_DAVINCI_H */
