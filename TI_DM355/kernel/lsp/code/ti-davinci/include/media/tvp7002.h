...
/* analog muxing mode */
#define    TVP7002_AMUX_COMPOSITE  0
#define    TVP7002_AMUX_SVIDEO     1
typedef enum {
	TVP7002_MODE_INV = -1,
	TVP7002_MODE_AUTO = 0,	/* autoswitch mode (default)   */
	TVP7002_MODE_NTSC = 1,	/* (M, J) NTSC      525-line   */
	TVP7002_MODE_PAL = 2,	/* (B, D, G, H, I, N) PAL      */
	TVP7002_MODE_PAL_M = 3,	/* (M) PAL          525-line   */
	TVP7002_MODE_PAL_CN = 4,	/* (Combination-N) PAL         */
	TVP7002_MODE_NTSC_443 = 5,	/* NTSC 4.43        525-line   */
	TVP7002_MODE_SECAM = 6,	/* SECAM                       */
	TVP7002_MODE_PAL_60 = 7,	/* PAL 60          525-line    */
	TVP7002_MODE_AUTO_SQP = 8,	/* autoswitch mode (default)   */
	TVP7002_MODE_NTSC_SQP = 9,	/* (M, J) NTSC      525-line   */
	TVP7002_MODE_PAL_SQP = 0xA,	/* (B, D, G, H, I, N) PAL      */
	TVP7002_MODE_PAL_M_SQP = 0xB,	/* (M) PAL          525-line   */
	TVP7002_MODE_PAL_CN_SQP = 0xC,	/* (Combination-N) PAL         */
	TVP7002_MODE_NTSC_443_SQP = 0xD,	/* NTSC 4.43 525-line   */
	TVP7002_MODE_SECAM_SQP = 0xE,	/* SECAM                       */
	TVP7002_MODE_PAL_60_SQP = 0xF,	/* PAL 60          525-line    */
} tvp7002_mode;

#define V4L2_STD_TVP7002_ALL        (V4L2_STD_720P_30 | \
					V4L2_STD_720P_50 | \
					V4L2_STD_1080I_60 | \
					V4L2_STD_1080I_50 | \
					V4L2_STD_525P_60)
...
/* enum */
typedef enum tvp7002_mode {
	TVP7002_MODE_480i_30FPS = 6,
	TVP7002_MODE_576i_25FPS = 5,
	TVP7002_MODE_480p_30FPS = 3,
	TVP7002_MODE_576p_25FPS = 4,
	TVP7002_MODE_720p_30FPS  = 1,
	TVP7002_MODE_720p_25FPS = 2
};
...
struct tvp7002_params {
 ...
 /* Enum for TVP7002 output data width */
typedef enum tvp7002_datawidth {
	TVP7002_WIDTH_16BIT,
	TVP7002_WIDTH_8BIT
} tvp7002_datawidth_t;
...
typedef struct {
	...
	int amuxmode;
	int enablebt656sync;
	tvp7002_datawidth_t data_width;
...
typedef unsigned int tvp7002_cmd;

/* commands for setup the decoder */
#define TVP7002_SET_AMUXMODE        4
#define TVP7002_SET_BRIGHTNESS      5
#define TVP7002_SET_CONTRAST        6
#define TVP7002_SET_HUE             7
#define TVP7002_SET_SATURATION      8
#define TVP7002_SET_AGC             9
#define TVP7002_SET_VIDEOSTD        10
#define TVP7002_CLR_LOSTLOCK        11
#define TVP7002_CONFIG              12
#define TVP7002_RESET               13
#define TVP7002_POWERDOWN           14

#define TVP7002_GET_STATUS          15
#define TVP7002_GET_STD             16
#define TVP7002_INIT                17
#define TVP7002_CLEANUP             18

#define TVP7002_I2C_ADDR (0xb8>> 1)
/* Defines for TVP7002 register address */
#define TVP7002_OUTPUT1                 	(0x33)
#define TVP7002_OUTPUT2                 	(0x34)
#define TVP7002_OUTPUT3				(0x35)
#define TVP7002_OUTPUT4				(0x36)
#define TVP7002_OUTPUT5				(0x37)
#define TVP7002_OUTPUT6				(0x38)

#define TVP7002_I2C_REGISTERED			(1)
#define TVP7002_I2C_UNREGISTERED		(0)
...
#define TVP7002_HPLL_MSB_DEFAULT                (0x67)  //480P:0x35 720P:0x67        
#define TVP7002_HPLL_LSB_DEFAULT                (0x20)   //480P:0xa0 720P:0x20    
#define TVP7002_HPLL_CONTROL_DEFAULT            (0xA0)     //480P:0x18 720P:0x20  
#define TVP7002_HPLL_PHASE_SEL_DEFAULT          (0x80)           //REG:2
#define TVP7002_CLAMP_START_DEFAULT             (0x32)  //32         //REG:2
#define TVP7002_CLAMP_WIDTH_DEFAULT             (0x20)    //20       //REG:2
#define TVP7002_HSYNC_OUTWIDTH_DEFAULT          (0xfA)   //60        ggggg//REG:2
#define TVP7002_BLUE_FINE_GAIN_DEFAULT          (0x00)           //REG:2
#define TVP7002_GREEN_FINE_GAIN_DEFAULT         (0x00)           //REG:2
#define TVP7002_RED_FINE_GAIN_DEFAULT           (0x00)           //REG:2
#define TVP7002_BLUEF_OFFSETMSB_DEFAULT         (0x80)           //REG:2
#define TVP7002_GREENF_OFFSETMSB_DEFAULT        (0x80)           //REG:2
#define TVP7002_REDF_OFFSETMSB_DEFAULT          (0x80)           //REG:2
#define TVP7002_SYNC_CONTROL1_DEFAULT           (0x5B)    //20   ggggg  //REG:2     
#define TVP7002_HPLL_CLAMP_CTRL_DEFAULT         (0x2E)           //REG:2
#define TVP7002_SYNC_GREEN_THLD_DEFAULT         (0x5D)           //REG:2
#define TVP7002_SYNC_SEP_THLD_DEFAULT           (0x40)  //47         //REG:2
#define TVP7002_HPLL_PRE_COAST_DEFAULT          (0x01) //00     01     //REG:2
#define TVP7002_HPLL_POST_COAST_DEFAULT         (0x00)  //        00 //REG:2
#define TVP7002_OUTPUT_FORMATTER_DEFAULT        (0x46)//47       //REG:2
#define TVP7002_MISC_CONTROL1_DEFAULT           (0x11)//01   11  //REG:2
#define TVP7002_MISC_CONTROL2_DEFAULT           (0x00)//00   03  //REG:2
#define TVP7002_MISC_CONTROL3_DEFAULT           (0x01)//01   00  //REG:2
#define TVP7002_INPUT_MUX_SELECT1_DEFAULT       (0x00)           //REG:2
#define TVP7002_INPUT_MUX_SELECT2_DEFAULT       (0xc7)//67   c2 17 //REG:2
#define TVP7002_MVIS_STRIPPER_W_DEFAULT         (0x07)//480P:24 720P:12
#define TVP7002_BLUE_GREEN_COARSE_GAIN_DEFAULT  (0x77)       //REG:2    
#define TVP7002_RED_COARSE_GAIN_DEFAULT         (0x07)           //REG:2
#define TVP7002_FINE_OFFSET_LSBS_DEFAULT        (0x00)           //REG:2
#define TVP7002_BLUE_COARSE_OFFSET_DEFUALT      (0x10)           //REG:2
#define TVP7002_GREEN_COARSE_OFFSET_DEFAULT     (0x10)           //REG:2
#define TVP7002_RED_COARSE_OFFSET_DEFAULT       (0x10)           //REG:2
#define TVP7002_RED_COARSE_OFFSET_DEFAULT       (0x10)           //REG:2
#define TVP7002_HSOUT_OUTPUT_START_DEFAULT      (0x50)//08   0d  480P:0c 720P:0a 
#define TVP7002_MISC_CONTROL4_DEFAULT           (0x08)//00   08  //REG:2
#define TVP7002_ALC_ENABLE_DEFAULT              (0x80)           //REG:2
#define TVP7002_ALC_FILTER_DEFAULT              (0x53)           //REG:2
#define TVP7002_FINE_CLAMP_CONTROL_DEFAULT      (0x07)           //REG:2
#define TVP7002_POWER_CONTROL_DEFAULT           (0x00)           //REG:2
#define TVP7002_ADC_SETUP_DEFAULT               (0x50)           //REG:2
#define TVP7002_COARSE_CLAMP_CONTROL_DEFAULT    (0x00)           //REG:2
#define TVP7002_SOG_CLAMP_DEFAULT               (0x80)           //REG:2
#define TVP7002_ALC_PLACEMENT_DEFAULT           (0x5a)   //5a        //REG:2
#define TVP7002_VSYNC_ALIGNMENT_DEFAULT         (0x00)   //10        //REG:2
#define TVP7002_SYNC_BYPASS_DEFAULT             (0x00)           //REG:2
#define TVP7002_LINE_LENGTH_TOLERENCE_DEFAULT   (0x00) //03          //REG:2
#define TVP7002_ADC_REF_SETUP_DEFAULT           (0x04)           //REG:2
#define TVP7002_POWER_DOWN			(0x7F)                           //REG:2
#define TVP7002_VIDEO_BANDWIDTH_CONTROL_DEFAULT	(0x0f)     //01      //REG:2
#define TVP7002_AVID_START_PIXEL_LSBS_DEFAULT	(0x01)                 //REG:2
#define TVP7002_AVID_START_PIXEL_MSBS_DEFAULT	(0x2c)                 //REG:2
#define TVP7002_AVID_STOP_PIXEL_LSBS_DEFAULT	(0x06)                 //REG:2
#define TVP7002_AVID_STAOP_PIXEL_MSBS_DEFAULT	(0x2c)                 //REG:2
#define TVP7002_VBLK_F_0_START_L_OFF_DEFAULT	(0x05)                 //REG:2
#define TVP7002_VBLK_F_1_START_L_OFF_DEFAULT	(0x05)                 //REG:2
#define TVP7002_VBLK_F_0_DURATION_DEFAULT	(0x1e)                 //REG:2
#define TVP7002_VBLK_F_1_DURATION_DEFAULT	(0x1e)                 //REG:2
...
extern int tvp7002_ctrl(tvp7002_cmd cmd, void *arg);
