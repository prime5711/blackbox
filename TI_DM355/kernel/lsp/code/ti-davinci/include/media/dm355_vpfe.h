...
#define VPFE_WIN_P1024_720 	{0,0,(1024 + NUM_EXTRAPIXELS),(720 + NUM_EXTRALINES)}
#define VPFE_WIN_1440_1024 	{0,0,(1440 + NUM_EXTRAPIXELS),(1024 + NUM_EXTRALINES)}
...
#define V4L2_STD_MT9T001_SXVGA_30FPS (24)
#define V4L2_STD_MT9T001_VGA_VGA_30FPS (25)
#define V4L2_STD_MT9T001_5MP_7FPS 	(26)
...
#define VPFE_TW2835_MAX_FRAME_WIDTH      (720)
#define VPFE_TW2835_MAX_FRAME_HEIGHT     (576)		// for PAL or 480 for NTSC...fix max...
...
#define VPFE_MT9M131_MAX_FRAME_WIDTH     (1440)
...
#define VPFE_TW2835_MAX_FBUF_SIZE       \
		(VPFE_TW2835_MAX_FRAME_WIDTH*VPFE_TW2835_MAX_FRAME_HEIGHT*2)
