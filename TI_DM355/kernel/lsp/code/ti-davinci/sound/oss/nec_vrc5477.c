...
static void stop_dac(struct vrc5477_ac97_state *s, int lock)
{
...
static void start_dac(struct vrc5477_ac97_state *s, int lock)
{
	struct dmabuf* db = &s->dma_dac;
	u32 dmaLength;
	u32 temp;
...
static void stop_adc(struct vrc5477_ac97_state *s, int lock)
{
...
static void start_adc(struct vrc5477_ac97_state *s, int lock)
{
	struct dmabuf* db = &s->dma_adc;
	u32 dmaLength;
	u32 temp;
