...
/* //defined include/media/ccdc_dm355.h 2009.02.05 by xact
...
*/
int ccdc_read_apro(int addr)
{
		unsigned int val = 0;
		//printk("ccdc_read_apro entered addr : %08x\n",addr);
/*		switch(addr)
		{
			case 0x0600:
					val = regr(SYNCEN);
...
void ccdc_write_apro(int addr, int val)
{
		//printk("ccdc_write_apro entered addr: 0x%x, val : 0x%x\n",addr,val);
		/*switch(addr)
		{
			case 0x0600:
					regw(val, SYNCEN);
...
void ccdc_readregs(void)
{
...
#if 1
	val = regr(SYNCEN);
	printk("Reading 0x%x to SYNCEN...\n", val);
	val = regr(MODESET);
	printk("Reading 0x%x to MODESET...\n", val);
	val = regr(HDWIDTH);
	printk("ReadingReading 0x%x to HDWIDTH...\n", val);
	val = regr(VDWIDTH);
	printk("ReadingReading 0x%x to VDWIDTH...\n", val);
	val = regr(PPLN);
	printk("Reading 0x%x to PPLN...\n", val);
	val = regr(LPFR);
	printk("Reading 0x%x to LPFR...\n", val);
	val = regr(SPH);
	printk("Reading 0x%x to SPH...\n", val);
	val = regr(NPH);
	printk("Reading 0x%x to NPH...\n", val);
	val = regr(SLV0);
	printk("Reading 0x%x to SLV0...\n", val);
	val = regr(SLV1);
	printk("Reading 0x%x to SLV1...\n", val);
	val = regr(NLV);
	printk("Reading 0x%x to NLV...\n", val);
	val = regr(CULH);
	printk("Reading 0x%x to CULH...\n", val);
	val = regr(CULV);
	printk("Reading 0x%x to CULV...\n", val);
	val = regr(HSIZE);
	printk("Reading 0x%x to HSIZE...\n", val);
	val = regr(SDOFST);
	printk("Reading 0x%x to SDOFST...\n", val);
	val = regr(STADRH);
	printk("Reading 0x%x to STADRH...\n", val);
	val = regr(STADRL);
	printk("Reading 0x%x to STADRL...\n", val);
	val = regr(CLAMP);
	printk("Reading 0x%x to CLAMP...\n", val);
	val = regr(DCSUB);
	printk("Reading 0x%x to DCSUB...\n", val);
	val = regr(COLPTN);
	printk("Reading 0x%x to COLPTN...\n", val);

	val = regr(BLKCMP0);
	printk("Reading 0x%x to BLKCMP0...\n", val);
	val = regr(BLKCMP1);
	printk("Reading 0x%x to BLKCMP1...\n", val);
	val = regr(MEDFILT);
	printk("Reading 0x%x to MEDFILT...\n", val);
	val = regr(RYEGAIN);
	printk("Reading 0x%x to RYEGAIN...\n", val);
	val = regr(GRCYGAIN);
	printk("Reading 0x%x to GRCYGAIN...\n", val);
	val = regr(GBGGAIN);
	printk("Reading 0x%x to GBGGAIN...\n", val);
	val = regr(BMGGAIN);
	printk("Reading 0x%x to BMGGAIN...\n", val);
	val = regr(OFFSET);
	printk("Reading 0x%x to OFFSET...\n", val);
	val = regr(OUTCLIP);
	printk("Reading 0x%x to OUTCLIP...\n", val);
	val = regr(VDINT0);
	printk("Reading 0x%x to VDINT0...\n", val);
	val = regr(VDINT1);
	printk("Reading 0x%x to VDINT1...\n", val);
	val = regr(RSV0);
	printk("Reading 0x%x to RSV0...\n", val);
	val = regr(GAMMAWD);
	printk("Reading 0x%x to GAMMAWD...\n", val);
	val = regr(REC656IF);
	printk("Reading 0x%x to REC656IF...\n", val);
	val = regr(CCDCFG);
	printk("Reading 0x%x to CCDCFG...\n", val);
	val = regr(FMTCFG);
	printk("Reading 0x%x to FMTCFG...\n", val);
	val = regr(FMTPLEN);
	printk("Reading 0x%x to FMTPLEN...\n", val);
	val = regr(FMTSPH);
	printk("Reading 0x%x to FMTSPH...\n", val);
	val = regr(FMTLNH);
	printk("Reading 0x%x to FMTLNH...\n", val);
	val = regr(FMTSLV);
	printk("Reading 0x%x to FMTSLV...\n", val);
	val = regr(FMTLNV);
	printk("Reading 0x%x to FMTLNV...\n", val);
	val = regr(FMTRLEN);
	printk("Reading 0x%x to FMTRLEN...\n", val);
	val = regr(FMTHCNT);
	printk("Reading 0x%x to FMTHCNT...\n", val);
	val = regr(FMT_ADDR_PTR_B);
	printk("Reading 0x%x to FMT_ADDR_PTR_B...\n", val);
	val = regr(FMTPGM_VF0);
	...
	val = regr(DATAOFST);
	printk("Reading 0x%x to DATAOFST...\n", val);
#endif
...
#define REG_PLLCTL1_PLL_DIV4	__REG(0x01c40800+0x160)
	...
	REG_PLLCTL1_PLL_DIV4 = 0x8002;

	printk("\nPLL1 DIV4 : [0x%x]=======>", pll2_div4);

	pll2_div4 = REG_PLLCTL1_PLL_DIV4;
	
	printk("[0x%x]\n", pll2_div4);
	
        clkctrl = regr_clk(CLKCTRL);
        //printk("1111******* clkctrl : %d\n",clkctrl);
        clkctrl &= 0x3f;
        clkctrl |= 0x40;
        mdelay(5);
        regw_clk(clkctrl, CLKCTRL);		
	//printk("2222******* clkctrl : %d\n",clkctrl);
...
void ccdc_config_ycbcr(ccdc_params_ycbcr * params)
{
	...
	//printk("UUUUUUUUUUUUUUUU TVP5150 Starting ccdc_config_ycbcr...\n");
	mdelay(5);
	ccdc_reset();
	...
	{
		//printk("UUUUUUUUUUUUUUUU TVP5150 bt656_enable OK\n");
		regw(3, REC656IF);
		mdelay(5);
	...
	else
	{
		...
		//printk("UUUUUUUUUUUUUUUU TVP5150 bt656_enable Not OK\n");
	...
	//printk("UUUUUUUUUUUUUUUU TVP5150 params->win : %d, params->frm_fmt : %d\n",params->win,params->frm_fmt);
	...
	if (params->buf_type == CCDC_BUFTYPE_FLD_INTERLEAVED) 
	{
		...
		//printk("UUUUUUUUUUUUUUUU TVP5150 CCDC_BUFTYPE_FLD_INTERLEAVED in ccdc_dm355.c\n");
		regw(0x00000249, SDOFST);
		mdelay(5);
	}
	else if(params->buf_type == CCDC_BUFTYPE_FLD_SEPARATED) 
	{
		//printk("UUUUUUUUUUUUUUUU TVP5150 CCDC_BUFTYPE_FLD_SEPARATED in ccdc_dm355.c\n");
	}
...
void ccdc_config_ycbcr_tw2835(ccdc_params_ycbcr * params)
{
	u32 modeset;
	unsigned int val;
	...
	/* This is important since we assume default values to be set in */
	/* a lot of registers that we didn't touch                       */
	dev_dbg(vpfe_dev, "\nStarting ccdc_config_ycbcr_tw2835...");
	//printk("KKKKKKKKKKKK Starting ccdc_config_ycbcr_mt9m131...\n");
	mdelay(5);
	ccdc_reset();
	...
	/* pack the data to 8-bit */
	modeset |= 0x1<< 11; // org 
	//modeset |= 0x0<< 11; // Not pack 8 ==>영상은 살아있으나 전체 화면이 어둡게 나옴
	...
	/* configure video window */
	//printk("MT9M131 params->win : %d, params->frm_fmt : %d\n",params->win,params->frm_fmt);
	ccdc_setwin(&params->win, params->frm_fmt, 2);
	mdelay(5);
	/* configure the order of y cb cr in SD-RAM */
	regw((params->pix_order << 11) | 0x8040, CCDCFG);
	...
	{
		/* two fields are interleaved in memory */
		//printk("MT9M131 CCDC_BUFTYPE_FLD_INTERLEAVED in ccdc_dm355.c\n");
		regw(0x00000249, SDOFST);
		mdelay(5);
	}
	else if(params->buf_type == CCDC_BUFTYPE_FLD_SEPARATED) 
	{
		//printk("MT9M131 CCDC_BUFTYPE_FLD_SEPARATED in ccdc_dm355.c\n");
	}	
	/*val = (unsigned int)ccdc_sbl_reset();
	dev_dbg(vpfe_dev, "\nReading 0x%x from SBL...\n", val);*/
	...
	//regw(0x8040, CCDCFG); //강제로 11번비트 Y8POS를 even pixel로 설정
	//mdelay(5);
...
void ccdc_config_ycbcr_mt9m131(ccdc_params_ycbcr * params)
{
	u32 modeset;
	unsigned int val;
	...
	/* This is important since we assume default values to be set in */
	/* a lot of registers that we didn't touch                       */
	dev_dbg(vpfe_dev, "\nStarting ccdc_config_ycbcr_mt9m131...");
	//printk("KKKKKKKKKKKK Starting ccdc_config_ycbcr_mt9m131...\n");
	mdelay(5);
	ccdc_reset();
	...
	// It's working
	//val = (0x1000) & CCDC_BLK_DC_SUB_MASK;
       //regw(val, DCSUB);

	//val = params->win.height / 60;
	//int vert_start = params->win.top, vert_nr_lines = params->win.height - 1;
	...
	//regw(val, VDINT1);
	//vert_start+=1;
	//regw(vert_start + (params->win.height / 2), VDINT1);      // Change by Gaurav
	//mdelay(5);
...
void ccdc_config_ycbcr_tvp7002(ccdc_params_ycbcr * params)
{
	u32 modeset;
	unsigned int val;
	...
	if (params->pix_fmt == CCDC_PIXFMT_YCBCR_16BIT)
	{
		...
		//printk("CCDC_PIXFMT_YCBCR_16BIT input\n");
	}else
		ccdc_setwin(&params->win, params->frm_fmt, 2);
...
void ccdc_config_raw(ccdc_params_raw * params)
{
        ...
        val |= CCDC_LATCH_ON_VSYNC_DISABLE;     //CCDC_LATCH_ON_VSYNC_ENABLE;
        mdelay(5);
        regw(val, CCDCFG);
        /*
        ...
        /*Set VDHD direction */
        mode_set |=
            (params->vdhd_dir & CCDC_VDHDOUT_MASK) << CCDC_VDHDOUT_SHIFT;

        /* config HD/VD sync. */
        if (params->vdhd_dir == CCDC_VDHD_OUTPUT) {
                if (params->hd_width < 4096) {
                        mdelay(5);
                        regw(params->hd_width & CCDC_HDWIDTH_MASK, HDWIDTH);
                } else
                        dev_err(vpfe_dev, "\ninvalid hd_width value....\n");
                if (params->vd_width < 4096) {
                        mdelay(5);
                        regw(params->vd_width & CCDC_VDWIDTH_MASK, VDWIDTH);
                } else
                        dev_err(vpfe_dev, "\ninvalid vd_width value....\n");
                mdelay(5);
                regw(params->pixels_per_line - 1, PPLN);
                mdelay(5);
                regw(params->halflines_per_frame - 1, LPFR);
		//printk("Set VD/HD output\n");
        }
...
int validate_ccdc_param(ccdc_config_params_raw * ccdcparam)
{
        if (ccdcparam->pix_fmt != 0) {
                dev_err(vpfe_dev, "Invalid value of pix_fmt, other than RAW data input is \
 not supported\n");
                return -1;
        }

        if (ccdcparam->frm_fmt != 0) {
                dev_err(vpfe_dev, "Other than Progressive fram format is not supported\n");
                return -1;
        }
        ...
        if (ccdcparam->vdhd_dir != CCDC_VDHD_INPUT
            && ccdcparam->vdhd_dir != CCDC_VDHD_OUTPUT) {
                dev_err(vpfe_dev, "Invalid value of VD/HD direction\n");
                return -1;
        }
        ...
        if (ccdcparam->lens_sh_corr.lsc_enable) {
                dev_err(vpfe_dev, "Lens shadding correction is not supported\n");
                return -1;
        }
