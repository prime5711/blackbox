...
//#if 1	//54 Mhz input   * (8 / 9) = 48Mhz
    ...
    */
	...
	else if (mode == MT9M131_MODE_P1280_720) 
	{
      //yun add for MT9D111
		printk("MT9M131_MODE_P1280_720 in mt9m131.c\n");
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x005, 0x011E, MT9M131_I2C_CONFIG);        //HBLANK (B) = 286
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x006, 0x00BD, MT9M131_I2C_CONFIG);        //VBLANK (B) = 189
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x007, 0x011E, MT9M131_I2C_CONFIG);        //HBLANK (A) = 286
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x008, 0x0073, MT9M131_I2C_CONFIG);        //VBLANK (A) = 115
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x020, 0x0303, MT9M131_I2C_CONFIG);        //Read Mode (B) = 768
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x021, 0x0000, MT9M131_I2C_CONFIG);        //Read Mode (A) = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x066, 0x1402, MT9M131_I2C_CONFIG);        //PLL Control 1 = 5122
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x067, 0x0500 , MT9M131_I2C_CONFIG);       //PLL Control 2 = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x065, 0xA000, MT9M131_I2C_CONFIG);        //Clock CNTRL: PLL ON = 40960
        mdelay(1); //DELAY= 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x065, 0x2000, MT9M131_I2C_CONFIG);        //Clock CNTRL: USE PLL = 8192

        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2717, MT9M131_I2C_CONFIG);       //Extra Delay (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x01C2, MT9M131_I2C_CONFIG);     //      = 450
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2719, MT9M131_I2C_CONFIG);       //Row Speed (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0011, MT9M131_I2C_CONFIG);     //   = 17
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2723, MT9M131_I2C_CONFIG);       //Extra Delay (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x01C2, MT9M131_I2C_CONFIG);     //      = 450
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2725, MT9M131_I2C_CONFIG);       //Row Speed (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0011, MT9M131_I2C_CONFIG);     //   = 17
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x276D, MT9M131_I2C_CONFIG);       //FIFO_Conf1 (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xE0E1, MT9M131_I2C_CONFIG);    //   = 57569
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA76F, MT9M131_I2C_CONFIG);      //FIFO_Conf2 (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00E1, MT9M131_I2C_CONFIG);            //     = 225
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2774, MT9M131_I2C_CONFIG);      //FIFO_Conf1 (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xE0E1, MT9M131_I2C_CONFIG);    //   = 57569
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA776, MT9M131_I2C_CONFIG);      //FIFO_Conf2 (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00E1, MT9M131_I2C_CONFIG);            //     = 225
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x220B, MT9M131_I2C_CONFIG);      //Max R12 (B)(Shutter Delay)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0459, MT9M131_I2C_CONFIG);    //   = 1113
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA217, MT9M131_I2C_CONFIG);      //IndexTH23
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0008, MT9M131_I2C_CONFIG);            //     = 8
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2228, MT9M131_I2C_CONFIG);      //RowTime (msclk per)/4
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0187, MT9M131_I2C_CONFIG);    //   = 391
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x222F, MT9M131_I2C_CONFIG);      //R9 Step
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00B8, MT9M131_I2C_CONFIG);    //   = 184
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA408, MT9M131_I2C_CONFIG);      //search_f1_50
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x002B, MT9M131_I2C_CONFIG);            //     = 43
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA409, MT9M131_I2C_CONFIG);      //search_f2_50
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x002D, MT9M131_I2C_CONFIG);            //     = 45
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA40A, MT9M131_I2C_CONFIG);      //search_f1_60
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0023, MT9M131_I2C_CONFIG);            //     = 35
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA40B, MT9M131_I2C_CONFIG);      //search_f2_60
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0025, MT9M131_I2C_CONFIG);            //     = 37
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2411, MT9M131_I2C_CONFIG);      //R9_Step_60
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00B8, MT9M131_I2C_CONFIG);    //   = 184
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2413, MT9M131_I2C_CONFIG);      //R9_Step_50
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00DD, MT9M131_I2C_CONFIG);    //   = 221

        //; 720p30 Settings
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2703, MT9M131_I2C_CONFIG);     //Output Width (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0500, MT9M131_I2C_CONFIG);     //      = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2705, MT9M131_I2C_CONFIG);     //Output Height (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x02D0, MT9M131_I2C_CONFIG);     //      = 720
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2707, MT9M131_I2C_CONFIG);     //Output Width (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0500, MT9M131_I2C_CONFIG);     //      = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2709, MT9M131_I2C_CONFIG);     //Output Height (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x02D0, MT9M131_I2C_CONFIG);     //      = 720
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x270B, MT9M131_I2C_CONFIG);     //mode_config
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0030, MT9M131_I2C_CONFIG);     //      = 48
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x270F, MT9M131_I2C_CONFIG);     //Row Start (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x010C, MT9M131_I2C_CONFIG);     //     = 28+240
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2711, MT9M131_I2C_CONFIG);     //Column Start (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00DC, MT9M131_I2C_CONFIG);     //     = 60+160
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2713, MT9M131_I2C_CONFIG);     //Row Height (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x02D0, MT9M131_I2C_CONFIG);     //     = 720
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2715, MT9M131_I2C_CONFIG);     //Column Width (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0500, MT9M131_I2C_CONFIG);     //     = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x271B, MT9M131_I2C_CONFIG);     //Row Start (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x010C, MT9M131_I2C_CONFIG);     //      = 28+240
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x271D, MT9M131_I2C_CONFIG);     //Column Start (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00DC, MT9M131_I2C_CONFIG);     //     = 60+160
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x271F, MT9M131_I2C_CONFIG);     //Row Height (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x02D0, MT9M131_I2C_CONFIG);     //     = 720
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2721, MT9M131_I2C_CONFIG);     //Column Width (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0500, MT9M131_I2C_CONFIG);     //     = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2727, MT9M131_I2C_CONFIG);         //Crop_X0 (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);     //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2729, MT9M131_I2C_CONFIG);     //Crop_X1 (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0500, MT9M131_I2C_CONFIG);     //      = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x272B, MT9M131_I2C_CONFIG);     //Crop_Y0 (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);     //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x272D, MT9M131_I2C_CONFIG);     //Crop_Y1 (A)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x02D0, MT9M131_I2C_CONFIG);     //      = 720
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2735, MT9M131_I2C_CONFIG);     //Crop_X0 (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);     //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2737, MT9M131_I2C_CONFIG);     //Crop_X1 (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0500, MT9M131_I2C_CONFIG);     //      = 1280
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2739, MT9M131_I2C_CONFIG);     //Crop_Y0 (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);     //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x273B, MT9M131_I2C_CONFIG);     //Crop_Y1 (B)
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x02D0, MT9M131_I2C_CONFIG);     //      = 720
        
       //[Max 30fps]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA20E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0004, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA217, MT9M131_I2C_CONFIG);    // MCU_ADDRESS
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0004, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        
        //;Slow down AE & Increase Gate & AE target
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA208, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_SKIP_FRAMES]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA107, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_AE_CONTBUFF]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA108, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_AE_CONTSTEP]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0003, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA206, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_TARGET]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0035, MT9M131_I2C_CONFIG);    // 45   // 44   // 40  // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA207, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_GATE]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x000A, MT9M131_I2C_CONFIG);    // 0F   // MCU_DATA_0
        //AE window size&position
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA202, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_WINDOW_POS]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0020, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA203, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_WINDOW_SIZE]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00AF, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA219, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_WEIGHTS]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x008F, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        //AE Analog/Digital Gain
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA210, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_MAX_VIRTGAIN]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0080, MT9M131_I2C_CONFIG);    // 90   // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA216, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AE_MAX_DGAIN_AE2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0028, MT9M131_I2C_CONFIG);    //20     // 30  // 40  // 70  // MCU_DATA_0
        
        //;slow down AWB
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA10B, MT9M131_I2C_CONFIG);// MCU_ADDRESS [SEQ_AWB_CONTBUFF]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0004, MT9M131_I2C_CONFIG);// MCU_DATA_0
        //To control registers at low light
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA115, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLMODE]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x006F, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA116, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLVIRTGAIN1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0020, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA117, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLVIRTGAIN2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0060, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA118, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLSAT1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0080, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA119, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLSAT2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA11A, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLINTERPTHRESH1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0018, MT9M131_I2C_CONFIG);    // 10   // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA11B, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLINTERPTHRESH2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0028, MT9M131_I2C_CONFIG);    // 40 // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA11C, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLAPCORR1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0007, MT9M131_I2C_CONFIG);    // 7    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA11D, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLAPCORR2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0005, MT9M131_I2C_CONFIG);    // 4     // 3     // 1    // 3  // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA11E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLAPTHRESH1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);    // 2    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA11F, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_LLAPTHRESH2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0004, MT9M131_I2C_CONFIG);    // 8    // MCU_DATA_0
        
        //; Tunning
        //;Sequencer States...
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA122, MT9M131_I2C_CONFIG); //Enter Preview: Auto Exposure
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG); //    = 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA123, MT9M131_I2C_CONFIG); //Enter Preview: Flicker Detection
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA124, MT9M131_I2C_CONFIG); //Enter Preview: Auto White Balance
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG); //    = 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA125, MT9M131_I2C_CONFIG); //Enter Preview: Auto Focus
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA126, MT9M131_I2C_CONFIG); //Enter Preview: Histogram
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG); //    = 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA127, MT9M131_I2C_CONFIG); //Enter Preview: Strobe Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA128, MT9M131_I2C_CONFIG); //Enter Preview: Skip Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA129, MT9M131_I2C_CONFIG); //In Preview: Auto Exposure
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0003, MT9M131_I2C_CONFIG); //    = 3
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA12A, MT9M131_I2C_CONFIG); //In Preview: Flicker Detection
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0002, MT9M131_I2C_CONFIG); //    = 2
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA12B, MT9M131_I2C_CONFIG); //In Preview: Auto White Balance
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0003, MT9M131_I2C_CONFIG); //    = 3
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA12C, MT9M131_I2C_CONFIG); //In Preview: Auto Focus
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA12D, MT9M131_I2C_CONFIG); //In Preview: Histogram
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0003, MT9M131_I2C_CONFIG); //    = 3
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA12E, MT9M131_I2C_CONFIG); //In Preview: Strobe Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA12F, MT9M131_I2C_CONFIG); //In Preview: Skip Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA130, MT9M131_I2C_CONFIG); //Exit Preview: Auto Exposure
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG); //    = 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA131, MT9M131_I2C_CONFIG); //Exit Preview: Flicker Detection
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG); //    = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA132, MT9M131_I2C_CONFIG); //Exit Preview: Auto White Balance
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG);   //      = 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA133, MT9M131_I2C_CONFIG); //Exit Preview: Auto Focus
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA134, MT9M131_I2C_CONFIG); //Exit Preview: Histogram
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0001, MT9M131_I2C_CONFIG);   //      = 1
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA135, MT9M131_I2C_CONFIG); //Exit Preview: Strobe Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA136, MT9M131_I2C_CONFIG); //Exit Preview: Skip Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA137, MT9M131_I2C_CONFIG); //Capture: Auto Exposure
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA138, MT9M131_I2C_CONFIG); //Capture: Flicker Detection
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA139, MT9M131_I2C_CONFIG); //Capture: Auto White Balance
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA13A, MT9M131_I2C_CONFIG); //Capture: Auto Focus
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA13B, MT9M131_I2C_CONFIG);     //Capture: Histogram
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA13C, MT9M131_I2C_CONFIG); //Capture: Strobe Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA13D, MT9M131_I2C_CONFIG);     //Capture: Skip Control
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);   //      = 0
        
        //[No1_D111_LSC_85]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x280, 0x01F8, MT9M131_I2C_CONFIG);    // LENS_CORRECTION_CONTROL
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x281, 0x6432, MT9M131_I2C_CONFIG);    // ZONE_BOUNDS_X1_X2
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x282, 0x3296, MT9M131_I2C_CONFIG);    // ZONE_BOUNDS_X0_X3
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x283, 0x9664, MT9M131_I2C_CONFIG);    // ZONE_BOUNDS_X4_X5
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x284, 0x5028, MT9M131_I2C_CONFIG);    // ZONE_BOUNDS_Y1_Y2
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x285, 0x2878, MT9M131_I2C_CONFIG);    // ZONE_BOUNDS_Y0_Y3
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x286, 0x7850, MT9M131_I2C_CONFIG);    // ZONE_BOUNDS_Y4_Y5
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x287, 0x0000, MT9M131_I2C_CONFIG);    // CENTER_OFFSET
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x288, 0x0013, MT9M131_I2C_CONFIG);    // FX_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x28B, 0x000A, MT9M131_I2C_CONFIG);    // FY_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x28E, 0x00A1, MT9M131_I2C_CONFIG);    // DF_DX_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x291, 0x0F28, MT9M131_I2C_CONFIG);    // DF_DY_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x294, 0x2DD4, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_0_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x297, 0xDED2, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_1_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x29A, 0x1517, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_2_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x29D, 0x0830, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_3_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A0, 0x1037, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_4_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A3, 0x1302, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_5_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A6, 0xD5A9, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_6_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A9, 0x030D, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_7_RED
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x289, 0x0004, MT9M131_I2C_CONFIG);    // FX_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x28C, 0x0002, MT9M131_I2C_CONFIG);    // FY_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x28F, 0x021A, MT9M131_I2C_CONFIG);    // DF_DX_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x292, 0x0F89, MT9M131_I2C_CONFIG);    // DF_DY_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x295, 0x3BDB, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_0_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x298, 0xD1B7, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_1_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x29B, 0x0C0B, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_2_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x29E, 0x0913, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_3_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A1, 0x1031, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_4_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A4, 0x0DF5, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_5_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A7, 0xAF88, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_6_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2AA, 0x158A, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_7_GREEN
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x28A, 0x0002, MT9M131_I2C_CONFIG);    // FX_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x28D, 0x0009, MT9M131_I2C_CONFIG);    // FY_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x290, 0x01A4, MT9M131_I2C_CONFIG);    // DF_DX_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x293, 0x009F, MT9M131_I2C_CONFIG);    // DF_DY_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x296, 0x1207, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_0_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x299, 0xD1BC, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_1_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x29C, 0x0EFE, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_2_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x29F, 0xFF0A, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_3_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A2, 0x0A15, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_4_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A5, 0x0DEB, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_5_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2A8, 0xC59B, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_6_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2AB, 0x0FA0, MT9M131_I2C_CONFIG);    // SECOND_DERIV_ZONE_7_BLUE
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2AC, 0x0000, MT9M131_I2C_CONFIG);    // X2_FACTORS
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2AD, 0x0000, MT9M131_I2C_CONFIG);    // GLOBAL_OFFSET_FXY_FUNCTION
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x2AE, 0x0000, MT9M131_I2C_CONFIG);    // K_FACTOR_IN_K_FX_FY
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x108, 0x01FC, MT9M131_I2C_CONFIG);    // COLOR_PIPELINE_CONTROL
        
        //[No1_D111_AWB&CCM]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2306, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_0]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x01B8, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2308, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFF2B, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x230A, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0020, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x230C, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_3]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFF6A, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x230E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_4]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x014E, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2310, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_5]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0050, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2312, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_6]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFF65, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2314, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_7]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFDD7, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2316, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_8]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x03F5, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2318, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_9]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0020, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x231A, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_L_10]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0035, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x231C, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_0]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x002C, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x231E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x001C, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2320, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFFC4, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2322, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_3]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x002B, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2324, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_4]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0061, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2326, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_5]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFF74, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2328, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_6]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x007D, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x232A, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_7]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x016C, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x232C, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_8]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFDEC, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x232E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_9]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x000A, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x2330, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_RL_10]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0xFFEE, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA348, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_GAIN_BUFFER_SPEED]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0004, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA349, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_JUMP_DIVISOR]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0002, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA34A, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_GAIN_MIN]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0053, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA34B, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_GAIN_MAX]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00C0, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA34F, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_POSITION_MIN]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA350, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CCM_POSITION_MAX]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x007F, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA35B, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_STEADY_BGAIN_OUT_MIN]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0073, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA35C, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_STEADY_BGAIN_OUT_MAX]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x008C, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA35D, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_STEADY_BGAIN_IN_MIN]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x007C, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA35E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_STEADY_BGAIN_IN_MAX]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0083, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0x235F, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_CNT_PXL_TH]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0064, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA361, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_TG_MIN0]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00DB, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA362, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_TG_MAX0]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00F6, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA302, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_WINDOW_POS]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA303, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_WINDOW_SIZE]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00EF, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA364, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_KR_L]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0086, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA365, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_KG_L]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0080, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA366, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_KB_L]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0080, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA367, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_KR_R]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0088, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA368, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_KG_R]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0080, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA369, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [AWB_KB_R]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0080, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA103, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [SEQ_CMD]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0005, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        
        //;Gamma settings
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA743, MT9M131_I2C_CONFIG);// MCU_ADDRESS [MODE_GAM_CONT_A]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0003, MT9M131_I2C_CONFIG);// MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA743, MT9M131_I2C_CONFIG);// MCU_ADDRESS [MODE_GAM_CONT_A]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0003, MT9M131_I2C_CONFIG);// MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA745, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_0]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0000, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA746, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_1]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0012, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA747, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_2]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0025, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA748, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_3]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x003C, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA749, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_4]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x005B, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA74A, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_5]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0073, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA74B, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_6]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0088, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA74C, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_7]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x009A, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA74D, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_8]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00A9, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA74E, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_9]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00B5, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA74F, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_10]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00C1, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA750, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_11]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00CB, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA751, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_12]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00D4, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA752, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_13]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00DD, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA753, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_14]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00E5, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA754, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_15]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00EC, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA755, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_16]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00F3, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA756, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_17]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00F9, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA757, MT9M131_I2C_CONFIG);    // MCU_ADDRESS [MODE_GAM_TABLE_A_18]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x00FF, MT9M131_I2C_CONFIG);    // MCU_DATA_0
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA103, MT9M131_I2C_CONFIG);// MCU_ADDRESS [SEQ_CMD]
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0005, MT9M131_I2C_CONFIG);// MCU_DATA_0
        
        mdelay(250); //DELAY = 250
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA103, MT9M131_I2C_CONFIG);     //Refresh Sequencer Mode
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0006, MT9M131_I2C_CONFIG);             //    = 6
        mdelay(250); //DELAY = 250
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C6, 0xA103, MT9M131_I2C_CONFIG);     //Refresh Sequencer
        err |= i2c_write_reg(&mt9m131_i2c_client, 0x1C8, 0x0005, MT9M131_I2C_CONFIG);             //    = 5
                                                                                              //
        /*yun delete for MT9D111
#if 1
