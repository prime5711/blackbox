...
Kernel_image_file='/mnt/mmc/update/uImage_NC1000W_blackbox_2.5M_1.5M_2012_1105_0948_rev237'
Rootfs_image_file='/mnt/mmc/update/nc1000w_fs_2012_1108_1723.bin.gz'
	...
	then 
		...
		if [ -f $SvnRevision ]
			then 
				...
				if [ $CUR_SVN_REVISION != "NC1000W_208" ] 
				then 
